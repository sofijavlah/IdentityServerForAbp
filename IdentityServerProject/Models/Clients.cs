        ...
        public static IEnumerable<Client> Get()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RequireConsent = false,
                    RedirectUris = {"https://127.0.0.1:57514/signin-oidc"},
                    PostLogoutRedirectUris = {"https://127.0.0.1:57514/signout-callback-oidc"},
                    FrontChannelLogoutUri = "https://127.0.0.1:57514/signout-oidc"
                }
            };
        }
    }
